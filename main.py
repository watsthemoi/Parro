...
class App(CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.OPTIONSFRAME = CTkFrame(master=self)
        self.OPTIONSFRAME.pack_propagate(False)
        self.OPTIONSFRAME.pack(fill="y", side="left")
        self.LB_TITLE = CTkLabel(master=self.OPTIONSFRAME, text="PARRO", height=25, fg_color=("#212121", "#212121"), bg_color=("#212121", "#212121"), text_color=("#ffffff", "#ffffff"), font=CTkFont(size=25, family="Fixedsys", weight="bold", overstrike=False))
        self.LB_TITLE.pack(padx=(10, 0), pady=(20, 0))
        self.BTN_HOME = CTkButton(master=self.OPTIONSFRAME, text="Home", fg_color=("#212121", "#212121"), text_color=("#ffffff", "#ffffff"), anchor="w", width=180, image=CTkImage(Image.open(r"assets\Assets\baseline_home_(255, 255, 255)_18dp_1x.png"), size=(18, 18)), bg_color=("#212121", "gray13"), hover_color=("#ff8080", "#ff5e5e"), font=CTkFont(size=20, family="Fixedsys"))
        ...
        self.LB_RECORDINGS = CTkLabel(master=self.OPTIONSFRAME, text="Recordings", height=25, fg_color=("#212121", "#212121"), bg_color=("#212121", "gray13"), text_color=("#ffffff", "#ffffff"), font=CTkFont(family="Fixedsys", size=20, weight="bold"))
        self.LB_RECORDINGS.pack(padx=(20, 0), pady=(20, 0), anchor="w")
        ...
        self.BTN_RESUMERECORDING.pack(padx=(10, 0), pady=(10, 0))
        self.LB_HZLINE = CTkLabel(master=self.OPTIONSFRAME, text="-----------------------------------------------------------------------------------", anchor="s", justify="center", height=0, text_color=("gray14", "#808080"), font=CTkFont(size=9))
        self.LB_HZLINE.pack(pady=(22,0))
        self.LB_COMPOSITIONS = CTkLabel(master=self.OPTIONSFRAME, text="Compositions", height=25, fg_color=("#212121", "#212121"), bg_color=("#212121", "gray13"), text_color=("#ffffff", "#ffffff"), font=CTkFont(size=15, family="Fixedsys", weight="bold"))
        ...
        self.BTN_RESUMECOMPOSITION.pack(padx=(10, 0), pady=(10, 0))
        self.MAINFRAME = CTkFrame(master=self, width=590, height=514, bg_color=("gray92", "#3e3e3e"), fg_color=("gray90", "#3e3e3e"))
        self.MAINFRAME.pack_propagate(False)
        self.MAINFRAME.pack(fill="both") 
        self.LB_RECENTS = CTkLabel(master=self.MAINFRAME, text="Recently Viewed", height=54, text_color=("#ffffff", "#ffffff"), width=271, fg_color="transparent", bg_color="transparent", font=CTkFont(family="Fixedsys", size=25))
        ...
        self.BTN_VIEW = CTkButton(master=self.FILEFRAME1, text="Open", fg_color=("#c0c0c0", "#808080"), bg_color="transparent", hover_color=("#808080", "#2a2a2a"), width=100, font=CTkFont(family="Fixedsys", size=14))
        ...
        self.BTN_VIEW = CTkButton(master=self.FILEFRAME2, text="Open", fg_color=("#c0c0c0", "#808080"), bg_color="transparent", hover_color=("#808080", "#2a2a2a"), width=100, font=CTkFont(family="Fixedsys", size=14))
        self.BTN_VIEW.pack(side="bottom")
        ...
        self.BTN_VIEW = CTkButton(master=self.FILEFRAME3, text="Open", fg_color=("#c0c0c0", "#808080"), bg_color="transparent", hover_color=("#808080", "#2a2a2a"), width=100, font=CTkFont(family="Fixedsys", size=14))
        self.BTN_VIEW.pack(side="bottom")
        ...
        self.BTN_VIEW = CTkButton(master=self.FILEFRAME4, text="Open", fg_color=("#c0c0c0", "#808080"), bg_color="transparent", hover_color=("#808080", "#2a2a2a"), width=100, font=CTkFont(family="Fixedsys", size=14))
        self.BTN_VIEW.pack(side="bottom")
        ...
        self.BTN_VIEW = CTkButton(master=self.FILEFRAME5, text="Open", fg_color=("#c0c0c0", "#808080"), bg_color="transparent", hover_color=("#808080", "#2a2a2a"), width=100, font=CTkFont(family="Fixedsys", size=14))
        self.BTN_VIEW.pack(side="bottom")
        ...
        self.BTN_VIEW = CTkButton(master=self.FILEFRAME6, text="Open", fg_color=("#c0c0c0", "#808080"), bg_color="transparent", hover_color=("#808080", "#2a2a2a"), width=100, font=CTkFont(family="Fixedsys", size=14))
        self.BTN_VIEW.pack(side="bottom")
