...
class HomePageView(CTkFrame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.BTN_RESUMECOMPOSITION = CTkButton(master=self.OPTIONSFRAME, text="Edit Composition", fg_color=("#212121", "#212121"), text_color=("#ffffff", "#ffffff"), anchor="w", width=180, image=CTkImage(Image.open(r"assets/Assets/baseline_edit_(255, 255, 255)_18dp_1x.png"), size=(18, 18)), bg_color=("#212121", "gray13"), hover_color=("#ff8080", "#ff5e5e"), font=CTkFont(size=15, family="Courier New"))
