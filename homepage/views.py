...
class HomePageView(CTkFrame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.LB_CREATE.pack(padx=(20, 0), pady=(10, 0), anchor="w")
        ...
        self.BTN_NEWCOMP.pack(padx=(5, 0), pady=(10, 0))
        ...
        self.BTN_NEWRECORDING.pack(padx=(5, 0), pady=(10, 0))
        ...
        self.BTN_RESUMERECORDING.pack(padx=(5, 0), pady=(10, 0))
        self.LB_HZLINE = CTkLabel(master=self.OPTIONSFRAME, text="-----------------------------------------------------------------------------------", anchor="s", justify="center", height=0, text_color=("gray14", "#808080"), font=CTkFont(size=9))
        self.LB_HZLINE.pack(pady=(22,0))
        ...
        self.BTN_RESUMECOMPOSITION.pack(padx=(5, 0), pady=(10, 0))
