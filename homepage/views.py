...
class HomePageView(CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.LB_RECORDINGS = CTkLabel(master=self.OPTIONSFRAME, text="Recordings", height=25, fg_color=("#212121", "#212121"), bg_color=("#212121", "gray13"), text_color=("#ffffff", "#ffffff"), font=CTkFont(family="Courier New", size=15, weight="bold"))
        ...
        self.LB_HZLINE = CTkLabel(master=self.OPTIONSFRAME, text="-----------------------------------------------------------------------------------", anchor="s", justify="center", height=0, text_color=("gray14", "#808080"), font=CTkFont(size=9))
        self.LB_HZLINE.pack(pady=(22,0))
        self.LB_COMPOSITIONS = CTkLabel(master=self.OPTIONSFRAME, text="Compositions", height=25, fg_color=("#212121", "#212121"), bg_color=("#212121", "gray13"), text_color=("#ffffff", "#ffffff"), font=CTkFont(size=15, family="Courier New", weight="bold"))
